...
ActiveRecord::Schema.define(version: 20170516191228) do
  ...
  create_table "laundries", id: :serial, force: :cascade do |t|
    t.string "name", null: false
    ...
    t.datetime "deleted_at"
    t.index ["city_id"], name: "index_laundries_on_city_id"
    t.index ["confirmation_token"], name: "index_laundries_on_confirmation_token", unique: true
    t.index ["deleted_at"], name: "index_laundries_on_deleted_at"
    t.index ["email"], name: "index_laundries_on_email", unique: true
    t.index ["reset_password_token"], name: "index_laundries_on_reset_password_token", unique: true
  end

  create_table "laundry_items", id: :serial, force: :cascade do |t|
    t.integer "laundry_id"
    t.integer "item_id"
    t.float "decoration_multiplier", default: 1.0
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id"], name: "index_laundry_items_on_item_id"
    t.index ["laundry_id"], name: "index_laundry_items_on_laundry_id"
  end

  create_table "laundry_treatments", id: :serial, force: :cascade do |t|
    t.integer "treatment_id"
    t.integer "price", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "laundry_id"
    t.index ["laundry_id"], name: "index_laundry_treatments_on_laundry_id"
    t.index ["treatment_id"], name: "index_laundry_treatments_on_treatment_id"
  end
  ...
  create_table "order_items", id: :serial, force: :cascade do |t|
    ...
    t.index ["laundry_item_id"], name: "index_order_items_on_laundry_item_id"
    t.index ["order_id"], name: "index_order_items_on_order_id"
  end

  create_table "order_treatments", id: :serial, force: :cascade do |t|
    ...
    t.integer "price", null: false
    t.integer "treatment_id"
    t.index ["laundry_treatment_id"], name: "index_order_treatments_on_laundry_treatment_id"
    t.index ["order_item_id"], name: "index_order_treatments_on_order_item_id"
    t.index ["treatment_id"], name: "index_order_treatments_on_treatment_id"
  end
  ...
  create_table "orders", id: :serial, force: :cascade do |t|
    ...
    t.index ["laundry_id"], name: "index_orders_on_laundry_id"
    t.index ["promo_code_id"], name: "index_orders_on_promo_code_id"
    t.index ["user_id"], name: "index_orders_on_user_id"
  end

  create_table "partner_applications", id: :serial, force: :cascade do |t|
  ...
  create_table "payment_tokens", id: :serial, force: :cascade do |t|
    t.boolean "paid", default: false
    ...
    t.index ["order_id"], name: "index_payment_tokens_on_order_id"
  end
  ...
  create_table "promo_codes", id: :serial, force: :cascade do |t|
    ...
    t.index ["laundry_id"], name: "index_promo_codes_on_laundry_id"
  ...
  create_table "promotions", id: :serial, force: :cascade do |t|
    ...
    t.datetime "valid_from"
    t.datetime "valid_until"
    t.index ["laundry_id"], name: "index_promotions_on_laundry_id"
  end
  ...
  create_table "ratings", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["laundry_id"], name: "index_ratings_on_laundry_id"
  ...
  create_table "schedules", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["laundry_id"], name: "index_schedules_on_laundry_id"
  end
  ...
  create_table "support_requests", id: :serial, force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "treatments", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.datetime "deleted_at"
    t.index ["deleted_at"], name: "index_treatments_on_deleted_at"
    t.index ["item_id"], name: "index_treatments_on_item_id"
  end
